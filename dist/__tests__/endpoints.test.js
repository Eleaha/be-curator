...
describe("/api/exhibitions", () => {
    ...
    describe("PATCH /api/exhibitions/pieces/:exhibition_piece_id", () => {
        test("PATCH 200 /api/exhibitions/pieces/:exhibition_piece_id - responds with the newly updated exhibition piece", () => __awaiter(void 0, void 0, void 0, function* () {
            const payload = {
                note: "new note",
            };
            const { body } = yield (0, supertest_1.default)(app_1.app)
        ...
        test("PATCH 200 /api/exhibitions/pieces/:exhibition_piece_id - can handle multiple field updates, responds with the newly updated exhibition piece", () => __awaiter(void 0, void 0, void 0, function* () {
            const payload = {
                piece_index: 6,
                note: "new note",
            };
        ...
        test("PATCH 404 /api/exhibitions/pieces/:exhibition_piece_id - non-existent id", () => __awaiter(void 0, void 0, void 0, function* () {
            const payload = {
                piece_index: 6,
                note: "new note",
            };
        ...
        test("PATCH 400 /api/exhibitions/pieces/:exhibition_piece_id - invalid id", () => __awaiter(void 0, void 0, void 0, function* () {
            const payload = {
                piece_index: 6,
                note: "new note",
            };
        ...
        test("PATCH 400 /api/exhibitions/pieces/:exhibition_piece_id - only allows for the piece index and note to be updated", () => __awaiter(void 0, void 0, void 0, function* () {
            const payload = {
                piece_id: 4,
                piece_index: 6,
                note: "new note",
        ...
        test("PATCH 400 /api/exhibitions/pieces/:exhibition_piece_id - invalid payload structure", () => __awaiter(void 0, void 0, void 0, function* () {
            const payload = {
                garbage: 6,
            };
            const { body } = yield (0, supertest_1.default)(app_1.app)
        ...
        test("PATCH 400 /api/exhibitions/pieces/:exhibition_piece_id - invalid payload data", () => __awaiter(void 0, void 0, void 0, function* () {
            const payload = {
                piece_index: "six",
            };
            const { body } = yield (0, supertest_1.default)(app_1.app)
    ...
    describe("DELETE /api/exhibitions/pieces/:exhibition_piece_id", () => {
        test("DELETE 204 /api/exhibitions/pieces/:exhibition_piece_id - successfully deletes exhibition piece", () => __awaiter(void 0, void 0, void 0, function* () {
            yield (0, supertest_1.default)(app_1.app).delete("/api/exhibitions/pieces/1").expect(204);
        }));
        test("DELETE 404 /api/exhibitions/:exhibition_piece_id - non-existent id", () => __awaiter(void 0, void 0, void 0, function* () {
            yield (0, supertest_1.default)(app_1.app).delete("/api/exhibitions/pieces/3000").expect(404);
        }));
        test("DELETE 400 /api/exhibitions/:exhibition_piece_id - invalid id", () => __awaiter(void 0, void 0, void 0, function* () {
            yield (0, supertest_1.default)(app_1.app).delete("/api/exhibitions/pieces/garbage").expect(400);
        }));
    });
});
