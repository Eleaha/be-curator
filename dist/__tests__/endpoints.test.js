...
describe("/api/piece", () => {
    describe("GET /api/piece/:institution_id/:piece_id", () => {
        test("GET 200 /api/piece/:institution_id/:piece_id - responds with a piece object when querying institution 1", () => __awaiter(void 0, void 0, void 0, function* () {
            const { body } = yield (0, supertest_1.default)(app_1.app).get("/api/piece/1/O1223170").expect(200);
            const { piece } = body;
            const isValidData = data_schemas_1.PieceSchema.safeParse(piece);
            expect(isValidData.success).toBe(true);
        }));
        test("GET 200 /api/piece/:institution_id/:piece_id - responds with a piece object when querying institution 2", () => __awaiter(void 0, void 0, void 0, function* () {
            const { body } = yield (0, supertest_1.default)(app_1.app)
        ...
        test("GET 400 /api/piece/:institution_id/:piece_id - invalid institution_id", () => __awaiter(void 0, void 0, void 0, function* () {
            const { body } = yield (0, supertest_1.default)(app_1.app)
                .get("/api/piece/garbage/SK-A-2860")
                .expect(400);
            expect(body.msg).toBe("Bad Request");
        }));
        test("GET 404 /api/piece/:institution_id/:piece_id - piece not found for institution 1", () => __awaiter(void 0, void 0, void 0, function* () {
            const { body } = yield (0, supertest_1.default)(app_1.app).get("/api/piece/1/garbage").expect(404);
            expect(body.msg).toBe("Not Found");
        }));
        test("GET 404 /api/piece/:institution_id/:piece_id - piece not found for institution 2", () => __awaiter(void 0, void 0, void 0, function* () {
            const { body } = yield (0, supertest_1.default)(app_1.app).get("/api/piece/2/garbage").expect(404);
            expect(body.msg).toBe("Not Found");
        }));
    });
});
